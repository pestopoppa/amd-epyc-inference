...
- **Monolithic seed_specialist_routing.py deprecated**: Added deprecation notice. All new development targets v2 modules (`seeding_orchestrator.py`, `seeding_eval.py`, `seed_specialist_routing_v2.py`). Monolithic file retained for backwards-compatible test imports only.
