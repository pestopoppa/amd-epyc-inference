> **DEPRECATED**: This handoff has moved to `handoffs/active/draft-benchmark.md`. This file is kept for historical reference only.
...
**Primary Results (ALWAYS update):**
- `research/RESULTS_SUMMARY.md` - new speed records, acceptance rates
- `docs/reference/benchmarks/RESULTS.md` - reference copy (keep in sync)
- `logs/research_report.md` - main results document

**Model Configuration:**
- `orchestration/model_registry.yaml` - draft performance data, compatible_targets
- `CLAUDE.md` - if new quirks/constraints discovered
...
**Task Tracking:**
- `orchestration/BLOCKED_TASKS.md` - mark tasks complete
- `research/formalizer_handoff.md` - update formalizer status

**Speculative Decoding Docs (if new findings):**
- `research/speculative_decoding_results.md` - detailed spec decode analysis
...
- [ ] research/RESULTS_SUMMARY.md updated with new records
- [ ] docs/reference/benchmarks/RESULTS.md synced
- [ ] logs/research_report.md updated
- [ ] benchmarks/results/reviews/ CSVs created
- [ ] BLOCKED_TASKS.md checklist updated
- [ ] formalizer_handoff.md status updated
- [ ] CLAUDE.md updated if new quirks found
- [ ] speculative_decoding_results.md updated if new findings
