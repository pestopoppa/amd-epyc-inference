...
DECOMPOSITION_PATTERNS = {
    ...
    "bug_investigation": {
        ...
        "plan": {
            ...
            "steps": [
                ...
                {"role": "coder_primary", "task": "Analyze error patterns and stack traces"},
                {"role": "architect_coding", "task": "Identify potential root causes"},
                {"role": "coder_primary", "task": "Implement and test fix"},
    ...
    "data_analysis": {
        ...
        "plan": {
            ...
            "steps": [
                ...
                {"role": "coder_primary", "task": "Generate visualizations"},
    ...
    "security_audit": {
        ...
        "plan": {
            ...
            "steps": [
                ...
                {"role": "coder_primary", "task": "Review code for vulnerabilities"},
    ...
    "documentation": {
        ...
        "plan": {
            "type": "documentation",
            "steps": [
                {"role": "coder_primary", "task": "Analyze code structure and interfaces"},
    ...
    "refactoring": {
        ...
        "plan": {
            ...
            "steps": [
                ...
                {"role": "coder_primary", "task": "Implement refactoring in small steps"},
                {"role": "worker_general", "task": "Verify tests still pass"},
                {"role": "coder_primary", "task": "Clean up and document changes"},
            ],
        },
    },
}
