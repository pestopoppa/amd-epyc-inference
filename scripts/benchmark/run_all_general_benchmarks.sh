#!/bin/bash
# Master Script: Run General/Instruct Benchmarks on All Models
# Tests instruction-following for worker_general, general_escalation, architect_general roles
set -euo pipefail
...
echo "=============================================="
echo "GENERAL/INSTRUCT MODEL BENCHMARK SUITE"
echo "Date: $(date)"
echo "=============================================="
...
declare -a MODELS=(
    ...
    "/mnt/raid0/llm/lmstudio/models/lmstudio-community/Meta-Llama-3.1-70B-Instruct-GGUF/Meta-Llama-3.1-70B-Instruct-Q4_K_M.gguf|Llama-3.1-70B-Instruct|dense"
    "/mnt/raid0/llm/lmstudio/models/lmstudio-community/Meta-Llama-3-8B-Instruct-GGUF/Meta-Llama-3-8B-Instruct-Q4_K_M.gguf|Llama-3-8B-Instruct|dense"
...
echo ""
echo "=============================================="
echo "GENERAL BENCHMARK SUITE COMPLETE"
echo "=============================================="
...
# Write summary file
{
    echo "General/Instruct Benchmark Summary"
    echo "Generated: $(date)"
    echo "=============================================="
    echo ""
    echo "Models Tested:"
    ...
    for model_spec in "${MODELS[@]}"; do
        ...
        # Determine configs based on arch
        case "$arch" in
