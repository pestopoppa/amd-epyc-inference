...
run_baseline() {
    ...
    [ ! -f "$model_path" ] && { echo "skip,0,0,0"; return; }
...
run_soft_mask() {
    ...
    [ ! -f "$model_path" ] && { echo "skip,0,0,0"; return; }
    [ -z "$override_kv" ] && { echo "skip,0,0,0"; return; }
...
run_external_draft() {
    ...
    [ ! -f "$target_path" ] && { echo "skip,0,0,0"; return; }
    [ ! -f "$draft_path" ] && { echo "skip,0,0,0"; return; }
