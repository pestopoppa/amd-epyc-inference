...
This directory contains research documents that have been superseded or represent failed approaches. They are preserved for historical reference.
...
- Implement approaches documented here without checking current status
